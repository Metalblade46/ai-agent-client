...
const Loading = () => {
  const messages = Math.floor(Math.random() * 5) + 2;
  return (
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="max-w-4xl mx-auto space-y-8">
            {[...Array(messages)].map((_, i) => (
              ...
              >
                <div
                  className={`w-2/3 rounded-2xl p-4 ${i % 2 == 0 ? "bg-blue-600/10 rounded-br-none" : "bg-white rounded-bl-none border borde-gray-200"}`}
                >
